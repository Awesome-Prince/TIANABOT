...
from Tianabot import pbot as innexia
...
async def hmm(_, message):
    ...
    if status == "ON" or status == "on" or status == "On":
        ...
        if not lol:
            ...
            return
        await lel.edit(
            f"PATRICIA AI Successfully Added For Users In The Chat {message.chat.id}"
        )
        ...
        if not Escobar:
            ...
            return
        await lel.edit(
            f"PATRICIA AI Successfully Deactivated For Users In The Chat {message.chat.id}"
        )
